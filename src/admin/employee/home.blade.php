...
@section('content')
    <div class="container-fluid my-4">
        <div class="row">
            <div class="col-md-12">
                <a class="btn btn-primary float-right mb-4" data-toggle="modal" data-target="#add"><i class="bi bi-plus-circle"></i> {{ __('interface.employee.create') }}</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <i class="bi bi-person"></i> {{ __('interface.misc.employees') }}
                    </div>
                    <div class="card-body">
                        <table id="employees" class="table mt-4 w-100">
                            <thead>
                            <tr>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="addLabel"><i class="bi bi-plus-circle"></i> {{ __('interface.employee.create') }}</h5>
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-md-8">
                                <select id="role" class="form-control @error('role') is-invalid @enderror" name="role">
                                    <option value="employee">{{ __('interface.data.employee') }}</option>
                                    <option value="admin">{{ __('interface.data.administrator') }}</option>
                                </select>
                            </div>
                        </div>
